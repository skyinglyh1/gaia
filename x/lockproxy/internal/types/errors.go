...
func ErrDeserializeHeader(codespace sdk.CodespaceType, err error) error {
	return sdk.NewError(codespace, CodeDeserializeHeaderFailType, fmt.Sprintf("Header deserialization error:%s", err.Error()))
}

func ErrMarshalSpecificTypeFail(codespace sdk.CodespaceType, o interface{}, err error) error {
...
func ErrUnmarshalSpecificTypeFail(codespace sdk.CodespaceType, o interface{}, err error) error {
...
func ErrFindKeyHeight(codespace sdk.CodespaceType, height uint32, chainId uint64) error {
...
func ErrGetConsensusPeers(codespace sdk.CodespaceType, height uint32, chainId uint64) error {
...
func ErrBookKeeperNum(codespace sdk.CodespaceType, headerBookKeeperNum int, consensusNodeNum int) error {
...
func ErrInvalidPublicKey(codespace sdk.CodespaceType, pubkey string) error {
	return sdk.NewError(codespace, CodeInvalidPublicKeyType, fmt.Sprintf("invalid pubkey error:%s", pubkey))
}

func ErrVerifyMultiSignatureFail(codespace sdk.CodespaceType, err error, height uint32) error {
...
func ErrInvalidChainId(codespace sdk.CodespaceType, chainId uint64) error {
	return sdk.NewError(codespace, CodeUnknownChainId, fmt.Sprintf("unknown chainId with id %d", chainId))
}

func ErrEmptyTargetHash(codespace sdk.CodespaceType, targetHashStr string) error {
	return sdk.NewError(codespace, CodeEmptyTargetHashType, fmt.Sprintf("empty target asset hash %s", targetHashStr))
}
func ErrBelowCrossedLimit(codespace sdk.CodespaceType, limit sdk.Int, storedCrossedLimit sdk.Int) error {
...
func ErrCrossedAmountOverLimit(codespace sdk.CodespaceType, newCrossedAmount sdk.Int, crossedLimit sdk.Int) error {
...
func ErrCrossedAmountOverflow(codespace sdk.CodespaceType, newCrossedAmount sdk.Int, storedCrossedAmount sdk.Int) error {
...
func ErrSupplyKeeperMintCoinsFail(codespace sdk.CodespaceType) error {
	return sdk.NewError(codespace, CodeSupplyKeeperMintCoinFailType, fmt.Sprintf("supplyKeeper mint coins failed "))
}

func ErrSendCoinsToModuleFail(codespace sdk.CodespaceType, amt sdk.Coins, fromAddr sdk.AccAddress, toAcct sdk.AccAddress) error {
...
func ErrSendCoinsFromModuleFail(codespace sdk.CodespaceType, amt sdk.Coins, fromAddr sdk.AccAddress, toAcct sdk.AccAddress) error {
...
func ErrCreateCrossChainTx(codespace sdk.CodespaceType, err error) error {
	return sdk.NewError(codespace, CodeGetCrossChainIdFailType, fmt.Sprintf("create cross chain tx error:%v", err))
}

func ErrCreateNegativeCoins(codespace sdk.CodespaceType, coins sdk.Coins) error {
